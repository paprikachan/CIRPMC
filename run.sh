in_fn=$1
out_fn=$2
cd /home/chenlingxi/mnt/chenlingxi/workspace/Bio_Projects/covid19/CIRPMC
...
/home/chenlingxi/mnt/chenlingxi/lib/tools/anaconda3/bin/Rscript \
    /home/chenlingxi/mnt/chenlingxi/workspace/Bio_Projects/covid19/CIRPMC/predict_CIRPMC.R \
    -i $in_fn \
    -o $out_fn 
